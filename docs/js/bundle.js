...
function initEmployees() {
  return {
    ...
    getEmployees: function getEmployees() {
      ...
      (0, _api["default"])().get('/employees').then(function (response) {
        console.log(response.data);
...
var url = "https://whispering-castle-04462.herokuapp.com/https://ninja-json-server.herokuapp.com/employees";
